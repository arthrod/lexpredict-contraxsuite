...
class TestLocalFileStorage(DjangoTestCase):
    ...
    def test_get_parent_dir(self):
        lfs = ContraxsuiteLocalFileStorage()
        self.assertEqual(lfs.get_parent_path('parent/sub-parent/child/'), 'parent/sub-parent')
        self.assertEqual(lfs.get_parent_path('parent/child'), 'parent')
