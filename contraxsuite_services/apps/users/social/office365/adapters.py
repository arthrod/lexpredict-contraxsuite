...
from apps.users.social.office365.provider import Office365Provider
from apps.users.social.custom_auxilary import format_data_message
...
class Office365OAuth2Adapter(CustomOAuth2Adapter):
    ...
    def _get_o365_tenant(self):
        ...
        return _settings.get('TENANT', 'consumers')  # TODO: previously it was 'common' instead of 'consumers'!
    ...
    def authorize_url(self):
        ...
        if settings.AZURE_AD_ALLOW_SWITCH_TENANT:
